...
import { UpdateAnnouncement, DeleteInvoice } from '@/app/ui/announcements/buttons';
              ...
              >
                <div className="flex items-center justify-between border-b pb-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{announcement.email}</p>
                  </div>
                  <InvoiceStatus status={announcement.status} />
                </div>
                <div className="flex w-full items-center justify-between pt-4">
                  <div>
                    <p className="text-xl font-medium">
                      {formatCurrency(announcement.amount)}
                    </p>
                    <p>{formatDateToLocal(announcement.date)}</p>
                  </div>
                  <div className="flex justify-end gap-2">
                    <UpdateAnnouncement id={announcement.id} />
                    <DeleteInvoice id={announcement.id} />
                  </div>
                </div>
              </div>
            ))}
